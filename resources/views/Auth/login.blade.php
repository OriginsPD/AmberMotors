        ...
        <div class="w-full py-32 lg:py-6 lg:h-100">
            ...
            <div class="flex justify-enter">
                ...
                <div class=" flex items-center justify-center ">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"<svg="" class="w-6 h-6" viewBox="0 0 48 48">
                    <defs>
                ...
                <button type="button" class="inline-flex px-4 py-3 ml-8 font-semibold text-blue-800 border rounded-lg border-blueGray-300 bg-black hover:bg-blue-800 focus:bg-blueGray-100 hover:text-blue-500">
                    <div class="flex items-center justify-center">
