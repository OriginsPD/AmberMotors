                ...
                <div
                    ...
                    <div class="relative flex-grow w-full">
                        ...
                        <input type="text" id="name" name="name"
                               class="w-full bg-gray-100 bg-opacity-50 rounded-lg border @error('name') border-red-700 @enderror  border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative flex-grow w-full">
                        ...
                        <input type="email" id="email" name="email"
                               class="w-full bg-gray-100 bg-opacity-50 rounded-lg border @error('email') border-red-700 @enderror  border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                ...
                <div
                    ...
                    <div class="relative flex-grow w-full">
                        ...
                        <input type="tel" id="phone_nbr" name="phone_nbr"
                               class="w-full bg-gray-100 bg-opacity-50 rounded-lg border @error('phone_nbr') border-red-700 @enderror border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative flex-grow w-full">
                        ...
                        <input type="text" id="address" name="address"
                               class="w-full bg-gray-100 bg-opacity-50 rounded-lg border @error('address') border-red-700 @enderror border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative flex-grow w-full">
                        ...
                        <input type="password" id="password" name="password"
                               class="w-full bg-gray-100 bg-opacity-50 rounded-lg border @error('password') border-red-700 @enderror border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative flex-grow w-full">
