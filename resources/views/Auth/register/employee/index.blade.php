...
@section('content')
    <section class="text-gray-600 body-font">
        <div class="w-full h-full bg-no-repeat bg-cover py-8 bg-blend-darken"
            style="background-image: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.3)),url('/img/bike-closeup.jpg')">
            <div class=" px-5  mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-6xl text-4xl font-bold uppercase title-font mb-4 text-white">Our Journey<br>Begins
                    </h1>
                ...
                <form class="rounded-lg py-12" style="background-color:white;width:60%;margin:auto"
                    ...
                    <div
                        ...
                        <div class="relative flex-grow w-full">
                            ...
                            <div>
                                ...
                                <button
                                    class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 w-full inline-flex items-center">
