        ...
        <div class="container px-5 py-16 mx-auto">
            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                <div class="sm:w-1/2 mb-10 px-4">
                    ...
                    <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Apply As Associate</h2>
                    ...
                    <a href="{{ route('RegisterEmployee.create') }}"><button class="flex mx-auto mt-6 text-white bg-blue-500 font-bold shadow-xl border-0 py-2 px-5 focus:outline-none hover:bg-blue-600 font-bold shadow-xl rounded">Apply</button></a>
                </div>
                <div class="sm:w-1/2 mb-10 px-4">
                    <div class="rounded-lg h-64 overflow-hidden">
                    ...
                    <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Join As Customer</h2>
