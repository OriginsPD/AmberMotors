...
<section class="">
  ...
  <div class=" flex flex-col rounded-lg overflow-hidden sm:flex-row max-h-16">
    ...
    <input class="py-3 px-4 bg-gray-200 text-gray-800 border-gray-300 border-2 outline-none placeholder-gray-500 focus:bg-gray-100" type="text" name="category" placeholder="Enter Category" required>
